...
// Load pre-built quiz data (generated by scripts/generate-quiz-data.js)
let quizData = {};
const quizDataPath = path.join(process.cwd(), "quiz-data.json");
if (fs.existsSync(quizDataPath)) {
  quizData = JSON.parse(fs.readFileSync(quizDataPath, "utf8"));
}
...
function loadQuestions(courseSlug) {
  const questions = quizData[courseSlug];
